export default {
  ...
  "tree": { name: "tree", tile: 257, mine: true, hardness: 2, yields: [{name: "wood", amount: 1}], hp: 1},
  ...
  "stone_ore": { name: "stone_ore", tile: 259, mine: true, hardness: 20, yields: [{name: "stone", amount: 2}], hp: 10},
