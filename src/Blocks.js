export default {
  ...
  "stone_ore": { name: "stone_ore", tile: 259, mine: true, hardness: 50, yields: [{name: "stone", amount: 2}]},
  "iron_ore": { name: "iron_ore", tile: 279, mine: true, hardness: 50, yields: [{name: "iron", amount: 2}]},
  "rubber_sap": { name: "rubber_sap", tile: 264, mine: true, hardness: 15, yields: [{name: "rubber", amount: 3}, {name: "wood", amount: 1}]},
